...
def test_create_user(client, request):
    ...
    print(f"USER1  =====>>    {User.objects.get(email='glich-gange@mail.ru')}")
...
#                                                           'last_name': 'Rogch12',
#                                                           'email': '2glich-gange@mail.ru',
#                                                           'password': '2Qwe123@rteA',
#                                                           'company': '2nelt11',
#                                                           'position': 2,
#                                                           'type': 'shop22',
#                                                           'username': 'gggg22'}, format='json')
#     print(response)
#     print(response.json())
#     print(response.json()['email'])
#     print(response.status_code)
...
#     assert response.status_code == 200
#     assert User.objects.count() == count_users_start1 + 1
    # assert User.objects.count() == count_users_start + 1
